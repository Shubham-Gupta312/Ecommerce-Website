    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?= ASSET_URL . 'public/images/Rectangle_7.png' ?>" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="<?= ASSET_URL . 'public/images/Rectangle_74.png' ?>" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="<?= ASSET_URL . 'public/images/bkg-banner11-1.png' ?>" class="d-block w-100" alt="...">
            </div>
        </div>
